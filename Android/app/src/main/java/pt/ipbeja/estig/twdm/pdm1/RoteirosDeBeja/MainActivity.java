    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, final long id) {
                final Routes routes = MainActivity.this.routesDao.getById(id);

                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                builder.setTitle("Favourites");
                String message = "Do you really want to add " + routes.getName() + " to favourites?";
                if (routes.isFav()) {
                    message = "Do you really want to remove " + routes.getName() + " from favourites?";
                }
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Routes routes = MainActivity.this.routesDao.getById(id);
                        boolean isFavourite = routes.isFav();
                        routes.setFav(!isFavourite);
                        MainActivity.this.routesDao.update(routes);
